...
### Design Principle
 ...
 5. **Princple of Accessibility** : Making the interface as accessible as it could be for the use of people with disabilities. Like using braile scripts on the interface for blind people, using some kind of descriptive drawing to describe the usage for the deaf people operating\n the device.
 ...
 7. **Ability to Learn** : How quickly new users can understand and use the interface effectively. The easier it is to learn to adapt to the system, the better the design. A system with consistent interactions and recognizable patterns will minimize the learnomg curve.
