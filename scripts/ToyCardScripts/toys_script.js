...
function onLoadCreateDatabase(){
    ...
    // BOOKS AND COMICS
    let Naruto_1 = new Toy("Naruto_1","9.99",5,50,"images/toyImages/WEBP/Naruto_1.webp","images/toyImages/JPEG/Naruto_1.jpeg","Books and Comics",10,["naruto", "manga", "comic book", "vol 1", "ninjas", "action", "adventure", "shonen", "japan", "team 7", "sasuke", "sakura", "kakashi", "hokage", "hidden leaf village", "ninjutsu", "battle", "friendship", "training", "story"]);

    let SpongeBob_Comic = new Toy("SpongeBob Comic Book","$12.99",4,30,"images/toyImages/WEBP/SpongeBob_Comic.webp","images/toyImages/JPEG/SpongeBob_Comic.jpeg","Books and Comics",8,["spongebob", "comic book", "cartoon", "funny", "underwater", "patrick", "squidward", "krusty krab", "bikini bottom", "adventure", "humor", "sea creatures", "comic", "kids", "story", "spongebob squarepants"]);
    ...
    let Monopoly = new Toy("Monopoly","$19.99",5,25,"images/toyImages/WEBP/Monopoly.webp","images/toyImages/JPEG/Monopoly.jpeg","Board Games", 8,["monopoly", "board game", "strategy", "real estate", "money", "competition", "family", "game", "buy", "sell", "houses", "property", "fun", "community chest", "chance"]);

    let Puzzle_3d = new Toy( "Puzzle 3D","$19.99",4,20,"images/toyImages/WEBP/Puzzle_3D.webp","images/toyImages/JPEG/Puzzle_3D.jpeg","Puzzles",12,["puzzle 3d", "puzzle", "building", "3D", "brain teaser", "architecture", "construction", "fun", "challenge", "family", "activity", "hands-on", "learning"]);
